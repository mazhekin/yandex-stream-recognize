...
operation = _descriptor.FieldDescriptor(
  name='operation', full_name='yandex.api.operation', index=0,
...
_OPERATION = _descriptor.Descriptor(
  name='Operation',
  full_name='yandex.api.Operation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='metadata', full_name='yandex.api.Operation.metadata', index=0,
...
Operation = _reflection.GeneratedProtocolMessageType('Operation', (_message.Message,), {
  ...
  '__module__' : 'yandex.api.operation_pb2'
  # @@protoc_insertion_point(class_scope:yandex.api.Operation)
  })
